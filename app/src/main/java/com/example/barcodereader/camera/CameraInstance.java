...
import com.example.barcodereader.utils.Util;
...
public class CameraInstance {
    ...
    private Runnable closer = new Runnable() {
        ...
        public void run() {
            ...
            //@TODO Обдумать эту идею. добавить
           // readyHandler.sendEmptyMessage(com.google.zxing.client.android.R.id.zxing_camera_closed);
