...
import com.example.barcodereader.camera.CameraInstance;
import com.example.barcodereader.camera.CameraParametersCallback;
import com.example.barcodereader.camera.CameraSettings;
import com.example.barcodereader.camera.CameraSurface;
import com.example.barcodereader.camera.CenterCropStrategy;
import com.example.barcodereader.camera.DisplayConfiguration;
import com.example.barcodereader.camera.FitCenterStrategy;
import com.example.barcodereader.camera.FitXYStrategy;
import com.example.barcodereader.camera.PreviewScalingStrategy;
...
public class CameraPreview extends ViewGroup {
    ...
    private final Handler.Callback stateCallback = new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            ...
            } else if (message.what == R.id.zxing_camera_closed123) {
    ...
    public void pause() {
        ...
        if (cameraInstance != null) {
            ...
            stateHandler.sendEmptyMessage(R.id.zxing_camera_closed123);
        }
